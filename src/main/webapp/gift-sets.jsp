...
<head>
    ...
    <title>Curated Gift Sets | LuxeGlow</title>
    <!-- Core & Specific Styling -->
    <link rel="stylesheet" href="index.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        .collection-hero {
            background: linear-gradient(rgba(92, 13, 30, 0.6), rgba(92, 13, 30, 0.8)), url('image/silkfoundation.jpg') no-repeat center center;
...
<!-- Include Glassmorphic Header -->
    ...
    <header class="collection-hero">
        <h1>Luxury Gift Sets</h1>
        <p>Pre-packaged elegance. Share the gift of radiant skin and premium formulas with someone special.</p>
    </header>
    ...
    <div class="page-container">
        ...
        <section class="products-grid">
            ...
            %>
            <div class="card">
                <span class="gift-badge"><i class="fas fa-gift" style="margin-right: 4px;"></i> Premium Gift</span>
