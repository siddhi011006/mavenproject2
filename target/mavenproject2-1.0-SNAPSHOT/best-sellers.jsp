...
<head>
    ...
    <title>Best Sellers | LuxeGlow</title>
    <!-- Core & Specific Styling -->
    <link rel="stylesheet" href="index.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        .collection-hero {
            background: linear-gradient(rgba(92, 13, 30, 0.6), rgba(92, 13, 30, 0.8)), url('image/roseperfume.jpg') no-repeat center center;
...
<!-- Include Glassmorphic Header -->
    ...
    <header class="collection-hero">
        <h1>Best Sellers</h1>
        <p>Explore our most coveted formulas, loved by skincare lovers and makeup experts alike.</p>
    </header>
        ...
        <section class="products-grid">
            <%
                ...
                try {
                    ...
                    // Fetch top 8 highest-rated products (ACTIVE only)
                    String sql = "SELECT id, name, description, price, category, rating FROM products WHERE status = 'ACTIVE' ORDER BY rating DESC, price DESC LIMIT 8";
            ...
            %>
            <div class="card">
                <span class="trending-badge"><i class="fas fa-fire-alt" style="margin-right: 4px;"></i> Best Seller</span>
